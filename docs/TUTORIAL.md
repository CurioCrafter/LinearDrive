...
Use the physical cockpit first. Hovered or urgent controls outline in the cockpit, and clicking the actual modeled part performs the action. Keyboard backups remain available:
